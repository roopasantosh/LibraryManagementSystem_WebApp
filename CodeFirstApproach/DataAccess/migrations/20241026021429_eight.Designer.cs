...
namespace LMS_Demo.DataAccess.migrations
{
    ...
    [Migration("20241026021429_eight")]
    partial class eight
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibraryManagementProject.Models.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AvailableCopies = 0,
                            CreatedBy = "Roopa",
                            CreatedOn = new DateTime(2024, 10, 25, 22, 14, 29, 157, DateTimeKind.Local).AddTicks(164),
                            IsAvailable = true,
                            Title = "C#",
                            UpdatedBy = "Roopa",
                        ...
                        new
                        {
                            ...
                            AvailableCopies = 0,
                            CreatedBy = "Suresh",
                            CreatedOn = new DateTime(2024, 10, 25, 22, 14, 29, 157, DateTimeKind.Local).AddTicks(225),
                            IsAvailable = true,
                            Title = "Art of living",
                            UpdatedBy = "Suresh",
                            UpdatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            ...
                            AvailableCopies = 0,
                            CreatedBy = "Swara",
                            CreatedOn = new DateTime(2024, 10, 25, 22, 14, 29, 157, DateTimeKind.Local).AddTicks(227),
                            IsAvailable = true,
                        ...
                        new
                        {
                            ...
                            AvailableCopies = 0,
                            CreatedBy = "Santosh",
                            CreatedOn = new DateTime(2024, 10, 25, 22, 14, 29, 157, DateTimeKind.Local).AddTicks(228),
                            IsAvailable = true,
                            Title = "Avarana",
                            UpdatedBy = "Santosh",
                            UpdatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
